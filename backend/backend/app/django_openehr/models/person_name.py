...
class PersonName(models.Model):
    ...
    NAME_TYPE_CHOICES = (
        (
            "REGISTERED",
            "Registered name [The name by which the subject is officially registered.]",
        ),
        ...
        (
            "PROFESSIONAL",
            "Professional name [The name used by the subject for business or professional purposes.]",
        ),
        (
            "REPORTING",
    ...
    middle_name = models.CharField(
        max_length=255, null=True, blank=True, help_text="Middle name or names."
    )
    ...
    validity_period_from = models.DateTimeField(
        null=True, blank=True, help_text="The date from which this name was valid."
    )
    validity_period_to = models.DateTimeField(
        null=True, blank=True, help_text="The date until which this name was valid."
    )
