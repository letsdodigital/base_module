...
class RelevantContact(models.Model):
    ...
    RELATIONSHIP_CATEGORY_CHOICES = (
        (
            "INFORMAL_CARER",
            "Informal carer [An individual identified by the person as offering care and support, excluding paid carers or carers from voluntary agencies.]",
        ),
        (
            "MAIN_INFORMAL",
            "Main informal carer [The contact is identified by the subject as being a primary informal source of care and support.]",
        ),
        (
            "FORMAL_CARE_WORKER",
            "Formal care worker [A health and social care professional or staff member, including a carer from voluntary sector.]",
        ),
        (
            "KEY_FORMAL_CARE_WORKER",
            "Key formal care worker [The formal carer is the subject's key worker.]",
        ),
    )
