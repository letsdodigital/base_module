...
class SymptomSign(models.Model):
    ...
    symptom_sign_name = models.CharField(
        max_length=255, help_text="The name of the reported symptom or sign."
    )

    # Nil significant
    # Boolean
    # Optional
    nil_significant = models.BooleanField(
        null=True,
        blank=True,
    ...
    # Boolean
    # Optional
    first_ever = models.BooleanField(
        blank=True,
    ...
    SEVERITY_CATEGORIES_CHOICES = (
        (
            "MILD",
            "Mild [The intensity of the symptom or sign does not cause interference with normal activity.] [SNOMED-CT::162468002] (Symptom mild (finding)",
        ),
        (
            "MODERATE",
            "Moderate: Moderate [The intensity of the symptom or sign causes interference with normal activity.] [SNOMED-CT::162469005] (Symptom moderate (finding)",
        ),
        (
            "SEVERE",
            "Severe: Severe [The intensity of the symptom or sign prevents normal activity.] [SNOMED-CT::162470006] (Symptom severe (finding)",
        ),
    )
